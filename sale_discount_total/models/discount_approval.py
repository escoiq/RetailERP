...
class sale_discount(models.Model):
    ...
    def action_confirm(self):
        ...
        no_line = 0.0
        for order in self:
            if not self._context.get('from_approve_button') and self.company_id.so_double_validation == 'two_step':
        ...
        return super(sale_discount, self).action_confirm()

    @api.multi
    def action_approve(self):
        return self.with_context({'from_approve_button':True}).action_confirm()
