...
class SaleOrderline(models.Model):
    ...
    def _compute_amount(self):
        ...
        for line in self:
            ...
            # taxes = line.tax_id.compute_all(self.discount_amount, line.order_id.currency_id, line.product_uom_qty, product=line.product_id, partner=line.order_id.partner_shipping_id)
            line.update({
